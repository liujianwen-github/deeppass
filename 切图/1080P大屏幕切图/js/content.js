...
function oBrushCardSuccess(num){
    ...
    var str2 = '<li><div class="userHead"><img src="images/head.jpg" alt=""/></div><div class="userInformation"><p class="name">张先生</p><p class="time">到访时间：15:00</p><div class="message" style="text-align: center;">识别成功，欢临您！</div></div></li>';
    ...
    var strList = str1+str2+str1+str2+str3+'<li><div class="userHead"><img src="images/head.jpg" alt=""/></div><div class="userInformation"><p class="name">刘女士</p><p class="time">到访时间：18:33</p><div class="message">您今天晚上 19:30 的会议马上就要开始了哦</div></div></li>';
    ...
    if(num>3){
        ...
        // num=0;
        times = setInterval('AutoScroll($("#scanSuccessList"))', 3000);
    }
