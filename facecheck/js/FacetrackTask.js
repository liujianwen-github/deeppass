...
$(function() {
    ...
    $.ajax({
        type: "post",
        url: config.HOST + "lowrenthouse/management/getFacetrackTask",
        //		url : '01.json',
        timeout: 100000,
        data: {
            'userkey': 1
        ...
        success: function(data) {
            ...
            //		****F-P****
                ...
                //				添加场景图
                $('#sencePicture .content').append('<img src="data:image/jpg;base64,' + scene + '" />');
                //	************公共部分结束*******************************************
                //				双击删除图片	
...
function getFimg(facetrackId){
	$.ajax({
		type:"post",
		url: config.HOST + "lowrenthouse/facetrack/getFacetrackImages",
		data: {
			'facetrackId': facetrackId,
			'count': 7
		},
		success: function (data) {
			...
			if(data != null && data != 'null' && data != ''){
				...
				if(results != null && results != 'null' && results != ''){
					var imgs = results.facetrackImagePos;
