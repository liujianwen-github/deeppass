			...
			xmlhttp.onreadystatechange = function() {
				if (xmlhttp.readyState == 4) {
					if (xmlhttp.status == 200) {
						...
						// console.log(xmlhttp.responseXML.baseURI);
						// console.log(xmlhttp.responseXML.URL);
...
PL.pushletURL = '/apiServer/pushlet.srv';
		 //PL.pushletURL = '/client/pushlet.srv';
		// PL.pushletURL = PL._getWebRoot() + '/client/pushlet.srv';
		//PL.pushletURL = 'http://localhost:8080/client/pushlet.srv';
