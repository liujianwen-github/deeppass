...
function androidUpload() {
	...
	$('input[type=file]').on('change', function() {
		...
		reader.onload = function(e) {
			...
			// scp -P 22 androidBrowser.js
			// root@101.201.106.53:/usr/apache-tomcat-8.5.9/webapps/faceserver/weixin/js
...
function readefile(video) {
	...
	var startImg = self.setInterval(function() {
		...
		if (imgNum < totalImg) {
			...
			canvas.getContext('2d').drawImage(video, 0, 0, video.clientHeight,
					video.clientWidth);// 根据视频尺寸，绘制canvas的图像
			// console.log(canvas);
