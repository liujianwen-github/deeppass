							...
							var funs = {
								...
								"fileSelected": function() {
									...
									for (var index = 0; index < count; index++) {
										...
										var fileSize = 0;
										var phoneType = navigator.appVersion.toLowerCase();
										if (phoneType.match(/iphone/g)) {
											if (file.size >= 500 * 1024) {
												alert('iphone,并且超过500k,请重新上传');
												location.reload()
											}
										} else if (phoneType.match(/android/g)) {
											// alert(file);
											// console.log(file);
											// confirm("是否上传");
										...
										if (file.size > 1024 * 1024) {
											fileSize = (Math
													.round(file.size * 100 / (1024 * 1024)) / 100)
												.toString() + 'MB';
										} else {
											fileSize = (Math
