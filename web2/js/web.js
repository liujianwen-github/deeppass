...
var HOST = "http://192.168.1.18:8080/apiServer/";
var API_HOST =  "http://192.168.1.18:8080/apiServer/";
var userkey = "5f84bb25_4ea8_42c2_a6bf_744b0bb574a9";
//var personId = "e95fb8dd-00ae-4cbd-8e26-550f7b502f19";
var personId = null;
var facetrackid = "af948a0f-d1f1-4560-8b6b-0aaf6cf0d252";
function getUserKey(){
	
	return userkey;
}
function getPersonId(index){
	personId = $('#itemContainer .userInfos').eq(index).attr('userid');
	console.log(personId)
	return personId;
}
function getPersonId1(index){
	personId = $('#itemContainer .userInfos').eq(index).attr('userid');
	console.log(personId)
	return personId;
}
function facetrackId(){
	return facetrackid;
}
...
$('.JQ-slide-content').on('click', ".searchList", function() {
