		...
		.on(
				...
				function() {
					...
					str = '<div class="setHead"><img src="' + imgUrl
							...
							+ getUserInfoByPersonId(personId) + '</p>'
							+ '</div>'
 ...
 * @returns {String}
 */
function getUserInfoByPersonId(personId) {
	var noFrom = "";
	var infoUrl = config.HOST + "userManager/getUserInfoByPersonId";
	$.ajax({
		type : "get",
		url : infoUrl,
		async : false,
